...
要运行Online Judge，需要一个linux系统，且满足以下条件：
...
## 安装
  ...
  1. 通过clone或zip形式下载最新的代码 [code page](https://github.com/countstarlight/OnlineJudge) ，把clone或解压缩所得的文件放入网页文件夹里，例如apache2默认的文件夹是/var/www/html。
  ...
  9. **[重要]** [Online Judge安全相关](https://github.com/countstarlight/OnlineJudge/wiki)

## 安装之后

  * 阅读[文档](https://github.com/countstarlight/OnlineJudge/wiki)
